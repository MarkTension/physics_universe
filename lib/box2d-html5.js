...
goog.setTestOnly = function(a) {
  if (COMPILED && !goog.DEBUG)
    throw ((a = a || ""),
    Error(
      "Importing test-only code into non-debug environment" + a ? ": " + a : "."
    ));
};
COMPILED ||
...
goog.base = function(a, b, c) {
  ...
  for (
    var d = Array.prototype.slice.call(arguments, 2), f = !1, g = a.constructor;
    g;
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function(a) {
  ...
  a.step.warmStarting
    ? (this.m_impulse.SelfMul(a.step.dtRatio),
      ...
      (b = box2d.b2RevoluteJoint.prototype.InitVelocityConstraints.s_P.SetXY(
        this.m_impulse.x,
        this.m_impulse.y
      )),
      c.SelfMulSub(h, b),
          ...
          : this.m_limitState === box2d.b2LimitState.e_atUpperLimit &&
            ...
            0 < n
              ? ((n = -k.x + this.m_impulse.z * this.m_mass.ez.x),
                ...
                (this.m_impulse.z = 0))
              : this.m_impulse.SelfAdd(m)),
      (k = box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.SetXY(
        m.x,
        m.y
      )),
      b.SelfMulSub(f, k),
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function(a) {
  ...
  if (
    ...
    var k =
        box2d.b2DotVV(this.m_axis, box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0)) +
        this.m_a2 * d -
        this.m_a1 * c,
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function(a) {
  var b = a.velocities[this.m_indexA].v,
    ...
    k =
      k + (this.m_JwA * c - this.m_JwC * g + (this.m_JwB * d - this.m_JwD * l)),
    k = -this.m_mass * k;
  this.m_impulse += k;
...
box2d.b2Distance = function(a, b, c) {
  ...
  c.useRadii &&
    ...
    a.distance > b + d && a.distance > box2d.b2_epsilon
      ? ((a.distance -= b + d),
        (c = box2d.b2SubVV(a.pointB, a.pointA, box2d.b2Distance.s_normal)),
        c.Normalize(),
    ...
    for (a = this.m_bodyList; a; a = a.nextBody)
      for (
        ...
        var f = d.body,
          ...
          m = l * l + k * k;
        m < box2d.b2_epsilon ||
          ((l = box2d.b2GravityController.prototype.Step.s_f.SetXY(l, k)),
  ...
  1 === b
    ...
    : (a.indexA[0] === a.indexA[1]
        ? ((this.m_type = box2d.b2SeparationFunctionType.e_faceB),
          ...
          box2d
            .b2CrossVOne(box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0), this.m_axis)
            .SelfNormalize(),
          (f = box2d.b2MulRV(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal)),
        ...
        : ((this.m_type = box2d.b2SeparationFunctionType.e_faceA),
          ...
          box2d
            .b2CrossVOne(box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0), this.m_axis)
            .SelfNormalize(),
          (f = box2d.b2MulRV(c.q, this.m_axis, box2d.b2TimeOfImpact.s_normal)),
          box2d.b2MidVV(b, e, this.m_localPoint),
          (c = box2d.b2MulXV(
            c,
            this.m_localPoint,
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function(a, b, c) {
  ...
  switch (this.m_type) {
    ...
    case box2d.b2SeparationFunctionType.e_faceA:
      return (
        (c = box2d.b2MulRV(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal)),
        (e = box2d.b2MulXV(
          e,
          this.m_localPoint,
          box2d.b2TimeOfImpact.s_pointA
    ...
    case box2d.b2SeparationFunctionType.e_faceB:
      return (
        (c = box2d.b2MulRV(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal)),
        (d = box2d.b2MulXV(
          d,
          this.m_localPoint,
          box2d.b2TimeOfImpact.s_pointB
  ...
  switch (this.m_type) {
    case box2d.b2SeparationFunctionType.e_points:
      return (
        ...
        (e = box2d.b2MulXV(e, a, box2d.b2TimeOfImpact.s_pointA)),
        (d = box2d.b2MulXV(d, b, box2d.b2TimeOfImpact.s_pointB)),
        (e = box2d.b2DotVV(box2d.b2SubVV(d, e, box2d.b2Vec2.s_t0), this.m_axis))
      );
    case box2d.b2SeparationFunctionType.e_faceA:
      return (
        (c = box2d.b2MulRV(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal)),
...
box2d.b2Contact.prototype.Update = function(a) {
  ...
  if (e)
    (d = this.m_fixtureA.GetShape()),
      ...
      (c = box2d.b2TestOverlapShape(d, this.m_indexA, f, this.m_indexB, c, g)),
      (this.m_manifold.pointCount = 0);
  else {
...
box2d.b2PolygonShape.prototype.RayCast = function(a, b, c, e) {
  ...
  return 0 <= h
    ? ((a.fraction = f), box2d.b2MulRV(c.q, this.m_normals[h], a.normal), !0)
    : !1;
};
goog.exportProperty(
  box2d.b2PolygonShape.prototype,
...
box2d.b2CollideEdgeAndCircle = function(a, b, c, e, d) {
  ...
  if (0 >= k) {
    ...
    if (!(l > m * m)) {
      if (
        b.m_hasVertex0 &&
        ((b = box2d.b2SubVV(f, b.m_vertex0, box2d.b2CollideEdgeAndCircle.s_e1)),
    ...
    if (
      ...
      if (
        b.m_hasVertex3 &&
        ((f = box2d.b2SubVV(b.m_vertex3, g, box2d.b2CollideEdgeAndCircle.s_e2)),
...
box2d.b2EPCollider.prototype.Collide = function(a, b, c, e, d) {
  ...
  for (g = e.m_count; f < g; ++f)
    box2d.b2MulXV(this.m_xf, e.m_vertices[f], this.m_polygonB.vertices[f]),
      box2d.b2MulRV(this.m_xf.q, e.m_normals[f], this.m_polygonB.normals[f]);
...
box2d.b2EPCollider.prototype.ComputeEdgeSeparation = function(a) {
  ...
  for (var b = 0, c = this.m_polygonB.count; b < c; ++b) {
    var e = box2d.b2DotVV(
      this.m_normal,
      box2d.b2SubVV(this.m_polygonB.vertices[b], this.m_v1, box2d.b2Vec2.s_t0)
    );
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function(a) {
  ...
  a.separation = -box2d.b2_maxFloat;
  for (
    var b = box2d.b2EPCollider.s_perp.SetXY(-this.m_normal.y, this.m_normal.x),
      c = 0,
    ...
    var d = box2d.b2NegV(this.m_polygonB.normals[c], box2d.b2EPCollider.s_n),
      ...
      g = box2d.b2DotVV(
        d,
        box2d.b2SubVV(this.m_polygonB.vertices[c], this.m_v2, box2d.b2Vec2.s_t0)
      ),
      f = box2d.b2Min(f, g);
    if (f > this.m_radius) {
      ...
      0 >= g
        ...
        : 0 >= f
          ...
          : ((f = box2d.b2MidVV(
            ...
            (g = box2d.b2DotVV(box2d.b2SubVV(c, f, box2d.b2Vec2.s_t1), b[k])),
            g > d ||
              ((a.pointCount = 1),
              (a.type = box2d.b2ManifoldType.e_faceA),
    ...
    for (
      ...
      (h = g.points[c]),
        ...
        this.m_step.warmStarting
          ? ((k.normalImpulse = this.m_step.dtRatio * h.normalImpulse),
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function() {
  ...
  for (b = this.m_count; a < b; ++a) {
    ...
    2 === d.pointCount &&
      ...
      (k = k + m + n * f * h + p * s * l),
      u * u < 1e3 * (u * y - k * k)
        ? (d.K.ex.SetXY(u, k), d.K.ey.SetXY(k, y), d.K.GetInverse(d.normalMass))
        : (d.pointCount = 1));
  }
};
goog.exportProperty(
    ...
    if (1 === d.pointCount)
      ...
      for (
        c = d.points[0],
          ...
          box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= E.x && 0 <= E.y),
          box2d.b2SubVV(
...
box2d.b2PositionSolverManifold.prototype.Initialize = function(a, b, c, e) {
  ...
  switch (a.type) {
    case box2d.b2ManifoldType.e_circles:
      ...
      this.separation =
        box2d.b2DotVV(box2d.b2SubVV(f, d, box2d.b2Vec2.s_t0), this.normal) -
        a.radiusA -
        a.radiusB;
      break;
    case box2d.b2ManifoldType.e_faceA:
...
box2d.b2DynamicTree.prototype.RayCast = function(a, b) {
  if (null !== this.m_root) {
    ...
    for (m.Push(this.m_root); 0 < m.GetCount(); )
      if (
        ((l = m.Pop()), null !== l && !1 !== box2d.b2TestOverlapAABB(l.aabb, h))
      ) {
        ...
        if (
          !(
            0 <
            box2d.b2Abs(
              box2d.b2DotVV(d, box2d.b2SubVV(c, k, box2d.b2Vec2.s_t0))
            ) -
              box2d.b2DotVV(f, n)
          )
        )
...
box2d.b2Body.prototype.ApplyForce = function(a, b, c) {
  this.m_type === box2d.b2BodyType.b2_dynamicBody &&
    (0 === (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
    this.m_flags & box2d.b2BodyFlag.e_awakeFlag &&
      ((this.m_force.x += a.x),
      (this.m_force.y += a.y),
      (this.m_torque +=
...
box2d.b2Body.prototype.SetSleepingAllowed = function(a) {
  a
    ? (this.m_flags |= box2d.b2BodyFlag.e_autoSleepFlag)
    : ((this.m_flags &= ~box2d.b2BodyFlag.e_autoSleepFlag), this.SetAwake(!0));
};
goog.exportProperty(
  box2d.b2Body.prototype,
  "SetSleepingAllowed",
            ...
            if (
              ...
              l.m_fixtureA.m_isSensor ||
                ...
                l.m_flags & box2d.b2BodyFlag.e_islandFlag ||
                  (box2d.ENABLE_ASSERTS && box2d.b2Assert(g < e),
                  (d[g++] = l),
                  (l.m_flags |= box2d.b2BodyFlag.e_islandFlag)));
            }
          }
...
box2d.b2World.prototype.SolveTOI = function(a) {
  ...
  for (;;) {
    ...
    if (!1 === d.IsEnabled() || !1 === d.IsTouching())
      ...
      for (d = 0; 2 > d; ++d)
        if (
          ((e = 0 === d ? f : l), e.m_type === box2d.b2BodyType.b2_dynamicBody)
        )
          for (
            g = e.m_contactList;
            g &&
            ...
            (h = g.contact),
              h.m_flags & box2d.b2ContactFlag.e_islandFlag ||
                ...
                h.m_fixtureA.m_isSensor ||
                  k ||
                  ((k = box2d.b2World.prototype.SolveTOI.s_backup.Copy(
                    m.m_sweep
                  )),
                  0 === (m.m_flags & box2d.b2BodyFlag.e_islandFlag) &&
                    m.Advance(c),
                  h.Update(this.m_contactManager.m_contactListener),
                  !1 === h.IsEnabled()
                    ? (m.m_sweep.Copy(k), m.SynchronizeTransform())
                    : !1 === h.IsTouching()
                      ? (m.m_sweep.Copy(k), m.SynchronizeTransform())
                      : ((h.m_flags |= box2d.b2ContactFlag.e_islandFlag),
                        b.AddContact(h),
                        m.m_flags & box2d.b2BodyFlag.e_islandFlag ||
                          ((m.m_flags |= box2d.b2BodyFlag.e_islandFlag),
...
box2d.b2World.prototype.Dump = function() {
  if (
    box2d.DEBUG &&
    (this.m_flags & box2d.b2WorldFlag.e_locked) !== box2d.b2WorldFlag.e_locked
  ) {
    box2d.b2Log(
    ...
    for (
      ...
      if (!1 !== b.IsAwake()) {
        ...
        d < box2d.b2_epsilon ||
          ...
          b.ApplyForce(f, e),
          (e = b.GetLinearVelocityFromWorldPoint(c, new box2d.b2Vec2())),
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function(a) {
  var b = a.velocities[this.m_indexB].v,
    ...
    d = box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(
      this.m_impulse
    );
...
box2d.b2PulleyJoint.prototype.SolveVelocityConstraints = function(a) {
  var b = a.velocities[this.m_indexA].v,
    ...
    f =
      -box2d.b2DotVV(this.m_uA, f) - this.m_ratio * box2d.b2DotVV(this.m_uB, g),
    g = -this.m_mass * f;
  this.m_impulse += g;
  f = box2d.b2MulSV(
    -g,
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function(a) {
  ...
  0 < this.m_frequencyHz
    ? (box2d.b2MulRV(p, this.m_localXAxisA, this.m_ax),
      ...
      (b = b + c + e * this.m_sAx * this.m_sAx + d * this.m_sBx * this.m_sBx),
      0 < b &&
        ...
        (l = a.step.dt),
        (this.m_gamma =
          l * (2 * this.m_springMass * this.m_dampingRatio * p + l * f)),
        0 < this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
